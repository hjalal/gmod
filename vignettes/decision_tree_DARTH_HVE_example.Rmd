...
p_comp <- function(decision, HVE){
  ...
  # 
  p_HVE_comp*(decision == "DoNotTreat" & HVE ) + 
    p_OVE_comp*((decision == "DoNotTreat" | decision == "Biopsy") & !HVE ) + 
    p_HVE_comp_tx*((decision == "Treat" | decision == "Biopsy") & HVE ) + 
    p_OVE_comp_tx*(decision == "Treat" & !HVE ) 
