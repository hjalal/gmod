...
```{r}
n_cycles <- 5
gmod(name = "mygmod") + # for illustration it is 75 in the tutorial 
...
```{r}
gmod_evaluate_functions(mygmod, n_cycles = n_cycles)
...
model_results <- my_markov_model(mygmod, params = params, n_cycles = n_cycles, return_trace = T)
